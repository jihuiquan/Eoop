package com.movit.platform.sc.module.imagesbucket.helper;
...
public class AlbumHelper {
    ...
    List<ImageBucket> imageBucketsList = new ArrayList<ImageBucket>();
    List<ImageItem> imageItemsList = new ArrayList<ImageItem>();
    ...
    public List<ImageBucket> getImagesBucketList(boolean refresh) {
        ...
        bucket.imageList = getAllImagesList();
