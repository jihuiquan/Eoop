...
public class JCIFSEngine implements NTLMEngine {
    ...
    public String generateType1Msg(String domain, String workstation) throws NTLMEngineException {
        ...
        return Base64Utils.encode(type1Message.toByteArray());
    }
    ...
    public String generateType3Msg(String username, String password, String domain, String workstation, String challenge)
        ...
        try {
            type2Message = new Type2Message(Base64Utils.decode(challenge));
        ...
        return Base64Utils.encode(type3Message.toByteArray());
    }
}
