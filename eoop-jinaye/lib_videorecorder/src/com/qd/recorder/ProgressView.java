...
public class ProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!linkedList.isEmpty()) {
            ...
            //绘制三秒处的断点
            if (linkedList.getLast() <= FFmpegRecorderActivity.recordingChangeTime)
                canvas.drawRect(perPixel * FFmpegRecorderActivity.recordingChangeTime, 0, perPixel * FFmpegRecorderActivity.recordingChangeTime + threeWidth, getMeasuredHeight(), threePaint);
        } else//绘制三秒处的断点
            canvas.drawRect(perPixel * FFmpegRecorderActivity.recordingChangeTime, 0, perPixel * FFmpegRecorderActivity.recordingChangeTime + threeWidth, getMeasuredHeight(), threePaint);//绘制三秒处的矩形
