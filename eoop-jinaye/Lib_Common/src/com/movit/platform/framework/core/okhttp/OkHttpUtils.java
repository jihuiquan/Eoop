...
import com.movit.platform.framework.core.okhttp.builder.HeadBuilder;
import com.movit.platform.framework.core.okhttp.builder.OtherRequestBuilder;
import com.movit.platform.framework.core.okhttp.builder.PostFileBuilder;
import com.movit.platform.framework.core.okhttp.builder.PostFormBuilder;
import com.movit.platform.framework.core.okhttp.builder.PostStringBuilder;
import com.movit.platform.framework.core.okhttp.callback.Callback;
import com.movit.platform.framework.core.okhttp.cookie.CookieJarImpl;
import com.movit.platform.framework.core.okhttp.cookie.store.CookieStore;
import com.movit.platform.framework.core.okhttp.cookie.store.HasCookieStore;
import com.movit.platform.framework.core.okhttp.cookie.store.MemoryCookieStore;
import com.movit.platform.framework.core.okhttp.https.HttpsUtils;
...
import com.movit.platform.framework.core.okhttp.utils.Exceptions;
...
public class OkHttpUtils {
    ...
    public static GetBuilder getWithToken() {
        return new GetBuilder().addHeader("token", BaseApplication.Token);
    }
    ...
    public static PostStringBuilder postStringWithToken() {
        return new PostStringBuilder().addHeader("token", BaseApplication.Token);
    }
    ...
    public static PostFormBuilder postWithToken() {
        return new PostFormBuilder().addHeader("token", BaseApplication.Token);
    }
