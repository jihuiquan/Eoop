...
public class ChatLongClickPopupWindow extends PopupWindow {
    ...
    private Button btn_take_photo, btn_pick_photo, btn_cancel,btn_pick_attchment;
    private View mMenuView;

    public ChatLongClickPopupWindow(Activity context,OnClickListener itemsOnClick) {
            super(context);
            ...
            btn_pick_attchment = (Button) mMenuView.findViewById(R.id.btn_pick_attchment);
