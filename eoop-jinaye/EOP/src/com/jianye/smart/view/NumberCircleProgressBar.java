...
public class NumberCircleProgressBar extends View {
	...
	/**
	 * the Painter of the circle stork.
	 */
	...
	public NumberCircleProgressBar(Context context, AttributeSet attrs,
		...
		try {
			mFillMode = attributes
					.getInt(R.styleable.NumberCircleProgressBar_circle_progress_fill_mode,
							DEFAULT_FILL_MODE);
			mCircleRadius = attributes
					.getDimension(
							R.styleable.NumberCircleProgressBar_circle_progress_circle_radius,
							DEFAULT_CIRCLE_RADIUS);

			mReachedBarColor = attributes
					.getColor(
							R.styleable.NumberCircleProgressBar_circle_progress_reached_color,
							DEFAULT_REACHED_COLOR);
			mUnreachedBarColor = attributes
					.getColor(
							R.styleable.NumberCircleProgressBar_circle_progress_unreached_color,
							DEFAULT_UNREACHED_COLOR);
			mTextColor = attributes
					.getColor(
							R.styleable.NumberCircleProgressBar_circle_progress_text_color,
							DEFAULT_TEXT_COLOR);
			mTextSize = attributes
					.getDimension(
							R.styleable.NumberCircleProgressBar_circle_progress_text_size,
							DEFAULT_TEXT_SIZE);

			int textVisible = attributes
					.getInt(R.styleable.NumberCircleProgressBar_circle_progress_text_visibility,
			...
			setProgress(attributes.getInt(
					R.styleable.NumberCircleProgressBar_circle_progress, 0));
			setMax(attributes.getInt(
					R.styleable.NumberCircleProgressBar_circle_max, 100));
		} finally {
			attributes.recycle();
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		// draw the stroke
		canvas.drawCircle(centerX, centerY, (mCircleRadius - 2.5f),
				mStrokePaint);
	...
	private void initializePainters() {
		...
		mStrokePaint.setColor(mReachedBarColor);
